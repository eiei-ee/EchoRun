...
public sealed class AsyncEchoLeaderboardRow : MonoBehaviour
{
    ...
    public void Bind(AsyncEchoLeaderboardEntry item)
    {
        ...
        rank.color = item.rank == 1 ? AsyncEchoPanelView.Ink : AsyncEchoPanelView.Muted;
        ...
        distance.color = item.isMe ? AsyncEchoPanelView.Primary : AsyncEchoPanelView.Foreground;
